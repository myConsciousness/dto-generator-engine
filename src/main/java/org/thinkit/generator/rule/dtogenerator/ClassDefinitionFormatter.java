 ...
 * File Name : ClassDefinitionFormatter.java<br>
 * Encoding : UTF-8<br>
...
public final class ClassDefinitionFormatter extends AbstractRule {
    ...
    private ClassDefinitionFormatter() {
    }
     ...
     */
    public ClassDefinitionFormatter(final ClassDefinitionMatrix classDefinitionMatrix) {
        super();
    ...
    private boolean formatClassDefinitionRecursively(final RecursiveRequiredParameters parameters) {
        ...
        for (ClassDefinition classDefinition : classDefinitionList) {
            ...
            final DtoClassTemplate dtoClassTemplateCategory = this.organizeClassItemDefinition(classItemDefinitionList,
                    className, classNameDefinition, classCreatorDefinition, dtoTemplateManager,
                    dtoTemplateReplacementSequenceManager, formattedResources);
            ...
            final ResourceRequiredElements resourceRequiredElements = ResourceRequiredElements.of(
                    dtoClassTemplateManager.getDtoClassTemplate(), classNameDefinition, classCreatorDefinition,
                    classDefinition, dtoTemplateManager, dtoTemplateReplacementSequenceManager,
                    this.getFieldsDefinition(), this.getConstructorParameters(), this.getConstructorProcess(),
                    copyingConstructorParameter, this.getCopyingConstructorProcess());
    ...
    private DtoClassTemplate organizeClassItemDefinition(final List<ClassItemDefinition> classItemDefinitionList,
            ...
            final ClassCreatorDefinition classCreatorDefinition, final DtoTemplateManager dtoTemplateManager,
        ...
        for (ClassItemDefinition classItemDefinition : classItemDefinitionList) {
            ...
            this.createFieldsDefinition(classItemDefinition, dtoTemplateManager, dtoTemplateReplacementSequenceManager);
            ...
            if (!childClassDefinitionList.isEmpty()) {
                ...
                final RecursiveRequiredParameters newRequiredParameters = RecursiveRequiredParameters.of(
                        dtoTemplateManager, dtoTemplateReplacementSequenceManager, classNameDefinition,
                        classCreatorDefinition, childClassDefinitionList, formattedResources);
    ...
    private void createRequiredConstructor(final ClassItemDefinition classItemDefinition,
        ...
        this.createConstructorProcess(classItemDefinition, dtoTemplateManager, dtoTemplateReplacementSequenceManager);
    ...
    private void createFieldsDefinition(final ClassItemDefinition classItemDefinition,
        ...
        final String templateFieldDefinition = dtoTemplateManager.getTemplateByKey(DtoTemplate.FIELD_DEFINITION);
        ...
        final String fieldDefinition = this.replaceTemplate(templateFieldDefinition, replacementsFieldDefinition);
    ...
    private void createConstructorParamAnnotations(final ClassItemDefinition classItemDefinition,
        ...
        replacementsConstructorParamAnnotation.put(replacementVariableName, classItemDefinition.getVariableName());
    ...
    private void createConstructorProcess(final ClassItemDefinition classItemDefinition,
        ...
        final String replacementVariableName = dtoTemplateReplacementSequenceManager
                .getTemplateByKey(DtoTemplateReplacementSequence.VARIABLE_NAME);
        final String templateConstructorProcess = dtoTemplateManager.getTemplateByKey(DtoTemplate.CONSTRUCTOR_PROCESS);
     ...
     */
    private String getCopyingConstructorParameter(final String className, final DtoTemplateManager dtoTemplateManager,
            final DtoTemplateReplacementSequenceManager dtoTemplateReplacementSequenceManager) {
        logger.atInfo().log("START");
     ...
     * @param dtoTemplateReplacementSequenceManager DTOの雛形置換文字列を管理するルールクラス
     */
    private void createCopyingConstructorProcess(final String className, final ClassItemDefinition classItemDefinition,
            final DtoTemplateManager dtoTemplateManager,
            final DtoTemplateReplacementSequenceManager dtoTemplateReplacementSequenceManager) {
        logger.atInfo().log("SATRT");
    ...
    private String createResource(final ResourceRequiredElements resourceRequiredElements) {
        ...
        logger.atInfo().log("END");
        return this.replaceTemplate("", new HashMap<>());
    }
    ...
    private void prepareConstructorProcess(final String constructorProcess) {
        ...
        this.getConstructorProcess().append(constructorProcess).append(EscapeSequence.NEW_LINE.getEscapeSequence());
    }
